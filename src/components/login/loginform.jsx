...
export default function LoginForm(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            await axios.post(api + '/AuthenAPI/login', formData, {
                headers: {
                    'Content-Type': 'application/json'
                }
            }).then((response) => {
                // ตรวจสอบว่าคำตอบมีคุณสมบัติ 'message' และแสดงใน console.log
                ...
                <Row className="justify-content-center h-100">
                    <Col className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        <Stack className="mx-auto text-center my-5 mb-3" gap={2}>
                            <Image src="/img/logo.jpg" alt="logo" width="140" className="mx-auto" />
                        </Stack>
                        <Card className="shadow-lg">
                            <Card.Body className="p-4">
                                <h1 className="fs-4 card-title fw-bold mb-4">ล็อกอินเข้าสู่ระบบ</h1><hr></hr>
                                ...
                                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                    <Row className="mb-3">
                                        <Form.Group as={Col} className='mb-2' md="12" >
                                            ...
                                            />
                                            <Form.Control.Feedback type="invalid">กรุณากรอกชื่อล็อกอิน!</Form.Control.Feedback>
                                        </Form.Group>
                                        <Form.Group as={Col} md="12" className='mb-3'>
                                            ...
                                            <Form.Control
                                                ...
                                                onChange={handleChange}
                                            />
                                            <Form.Control.Feedback type="invalid">กรุณากรอกรหัสผ่าน!</Form.Control.Feedback>
                                        </Form.Group>
                                    </Row>
                                    <Row className='justify-content-end'>
                                        <Col md={12} className='text-end'>
                                            <Button type="submit" className="btn btn-success text-right ml-auto" disabled={loading}>
                                                {loading ? (
                                                    <>
